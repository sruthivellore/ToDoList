...
let Todo = require('./api/todo.model');
app.use(cors());
app.use(bodyParser.json());
// mongodb+srv://mongodb:<password>@cluster0.ls1pe.mongodb.net/<dbname>?retryWrites=true&w=majority
mongoose.connect('mongodb+srv://mongodb:1234@cluster0.ls1pe.mongodb.net/todolist?retryWrites=true&w=majority', { useNewUrlParser: true });
const connection = mongoose.connection;
// localhost:4000/getall/1
